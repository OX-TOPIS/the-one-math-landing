          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 max-w-[1200px] mx-auto">
            ...
            <div className="justify-items-center bg-white p-4 rounded-3xl bg-opacity-60 m-4">
              ...
              <p className="kanit-regular md:text-lg mt-2">
                ...
                พี่แก้พื้นฐานใหม่ให้หมด ตาม 13
                บทที่คัดมาแล้วว่าต่อยอดได้ทุกบท เรียนตั้งแต่พื้นฐานการคำนวณ ไปจนถึงการแก้สมการที่ซับซ้อน มีการบ้านท้ายบทครบ 13 บท
              </p>
            ...
            <div className="justify-items-center flex flex-col bg-white p-4 rounded-3xl bg-opacity-60 m-4">
              <div>
                ...
                <p className="kanit-regular md:text-lg mt-2">
                  ...
                  ถ้าอยู่ ม.4 หรือ ม.5 ก็สามารถสมัครเข้ามาเรียนเนื้อหาเพื่อเก็บเกรดที่โรงเรียนได้ แถมยังได้เตรียมสอบเข้ามหาลัยไปด้วย
                  เรียนซ้ำกี่รอบก็ได้ ไม่จำกัด
                </p>
              </div>
            ...
            <div className="justify-items-center flex flex-col bg-white p-4 rounded-3xl bg-opacity-60 m-4">
              <div>
                ...
                <p className="kanit-regular md:text-lg mt-2">
                  ได้รับเอกสารครบทั้งปรับพื้นฐาน เนื้อหาคณิตศาสตร์ ม.ปลายทั้งหมด
                  ซึ่งจะมีการบ้านให้ฝึกทำ และ ตะลุยโจทย์แยกบทและรวมบทตามข้อสอบแนวคณิตศาสตร์ประยุกต์ 1 โดยเฉพาะ
                </p>
              </div>
            ...
            <div className="justify-items-center bg-white p-4 rounded-3xl bg-opacity-60 m-4">
              ...
              <p className="kanit-regular md:text-lg mt-2">
                ...
                เพื่อให้น้องทำโจทย์ได้แม่นยำและรวดเร็วที่สุด นอกจากข้อสอบเก่าแล้ว พี่ได้สร้างโจทย์แนวคณิตศาสตร์ประยุกต์ 1 โดยเฉพาะ
                มาให้น้องๆฝึก น้องไม่ต้องไปเสียเวลาทำข้อสอบที่ไม่ตรงแพทเทิลข้อสอบจริงเป็นหลายพันข้อ
                ฝึกถูกจุดจะทำให้น้องได้คะแนนสูงในเวลาที่รวดเร็ว
              </p>
            </div>
            <div className="justify-items-center bg-white p-4 rounded-3xl bg-opacity-60 m-4">
              <div className="flex items-center gap-2">
              ...
              <p className="kanit-regular md:text-lg mt-2">
                เรียนตั้งแต่เนื้อหาพื้นฐาน ไปจนถึง ตะลุยโจทย์รายบท เรียนที่โรงเรียนไม่เข้าใจ
                ไม่ต้องกังวล พี่สอนใหม่หมด  พี่เรียบเรียงเนื้อหาเพื่อให้น้องทำโจทย์คณิต 1 ได้ในที่สุด พี่คัดโจทย์จากข้อสอบเก่ามาสอนเพิ่ม คัดมาแล้วว่า ถ้าฝึกตามนี้ คะแนนสอบคณิต 1 พุ่งสูงแน่นอน นอกจากนี้ยังมี Demo เรื่องกราฟกันสดๆในห้องเรียง
              </p>
            </div>
            <div className="justify-items-center bg-white p-4 rounded-3xl bg-opacity-60 m-4">
              <div className="flex items-center gap-2">
              ...
              <p className="kanit-regular md:text-lg mt-2">
                น้องจะได้ฝึกทำโจทย์ความยากระดับข้อสอบจริง พี่สร้างโจทย์ขึ้นมาเองกับทีมงานที่จบจุฬาทุกคน จาก "แพทเทิล" ข้อสอบที่ออกทุกปี
                และยังมีโจทย์ปีเก่าๆที่พี่คัดมาแล้วว่า เป็น "แนวเดียวกัน" กับข้อสอบคณิต 1 ทั้งหมดถูกสร้าง คัด และเรียบเรียงมาอย่างดี
              </p>
            </div>
            <div className="justify-items-center bg-white p-4 rounded-3xl bg-opacity-60 m-4">
              <div className="flex items-center gap-2">
              ...
              <p className="kanit-regular md:text-lg mt-2">
                ...
                "อยู่ข้างๆจนกว่าจะสอบติด" ถ้าพี่เห็นว่าน้องไม่เข้าใจในส่วนไหน พี่จะสร้างการบ้านเพื่อน้องคนเดียวโดยเฉพาะ เพื่อให้น้องได้เข้าใจจริงๆ และสอบติดมหาลัยเป้าหมายในที่สุด
              </p>
            </div>
              ...
              <div className="flex justify-center bg-tonelight1 w-full max-w-[550px] p-4 mx-auto rounded-md">
                <div>
                  <ul className="list-disc list-inside text-center space-y-4 md:text-lg">
                    ...
                    <li>ปัจจุบันทำงานในตำแหน่ง Performance Validation Engineer</li>
                  </ul>
        ...
        <div className="bg-white w-full max-w-[550px] p-4 mx-auto rounded-md md:text-lg">
          ...
          <div className="md:flex justify-between gap-4 mt-4">
            ...
            <div className="font-semibold text-xl mt-4 md:mt-0">
              ...
              <p className="text-sm kanit-semibold bg-tonelight1 p-1 rounded-md self-center text-center">**ราคาเปิดตัว จะหมดเขตเร็วๆนี้</p>
            </div>
          </div>
        </div>
      </div>
